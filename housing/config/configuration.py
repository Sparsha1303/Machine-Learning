from housing.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig, ModelTrainingConfig, ModelPusherConfig, TrainingPipelineConfig
...
class Configuration:
    def __init__(self, config_file_path = CONFIG_FILE_PATH, current_time_stamp = CURRENT_DATE_TIME) -> None:
        try:
    ...
    def get_data_ingestion_config(self)->DataIngestionConfig:
        try:
            ...
            ingested_data_dir = os.path.join(data_ingestion_artifact_dir, data_ingestion_info[DATA_INGESTION_DIR_NAME_KEY])
